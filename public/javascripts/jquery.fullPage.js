		...
		*/
		function addSlidesNavigation(section, numSlides){
		  ...
		  for(var i=0; i< numSlides; i++){
		    ...
		    // Only add tooltip if needed (defined by user)
		    var slidestooltip = options.slidesNavTooltips[i];

		    if (typeof slidestooltip !== 'undefined' && slidestooltip !== '') {
		      li += '<div class="fp-tooltip ' + options.slidesNavPosition + '">' + slidestooltip + '</div>';
		    }
